...
rng(seed)
%% dataset location
dataset_loc = ".../..." % please use your dataset path
current_path = pwd;
%% housing data
...
%% number of epochs
number_of_epoch = 100; % 1000 is recommended for parkinson motor
...
for epoch = 1: number_of_epoch
    ...
    plotter(epoch,plotFrequency,loss,yTrue_test,yPred_test,yPred_test_upper,yPred_test_lower);
end
%% Inference
